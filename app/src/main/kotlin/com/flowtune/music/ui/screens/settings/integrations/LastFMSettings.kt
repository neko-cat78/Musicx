                                    ...
                                    .onFailure { exception ->
                                        coroutineScope.launch(Dispatchers.Main) {
                                            ...
                                            loginError = when (exception) {
                                                is com.flowtune.lastfm.LastFM.LastFmException -> {
                                                    when (exception.code) {
